    ...
    <div className="auth-screen" style={{ alignItems: "flex-start", paddingTop: 48 }}>
      <div className="auth-card" style={{ maxWidth: 640, textAlign: "left" }}>
        ...
        <section style={{ marginBottom: 20 }}>
          <h3 style={{ fontSize: 15, marginBottom: 6 }}>1. O que é o Faro</h3>
          <p>
            Uma ferramenta de gestão financeira pra MEI e autônomo, com um motor de insights que analisa seus
            próprios lançamentos pra avisar sobre padrões de gasto, orçamento e prazos fiscais. O Faro não é
        ...
        <section style={{ marginBottom: 20 }}>
          ...
          <p>
            ...
            dados que você insere (transações, valores, categorias) são seus — o Faro só processa pra exibir
        ...
        <section style={{ marginBottom: 20 }}>
          ...
          <p>
            Não use o Faro pra armazenar dado de terceiro sem autorização, tentar acessar conta alheia, ou
        ...
        <section style={{ marginBottom: 20 }}>
          ...
          <p>
            ...
            Recomendamos manter seus próprios registros/backups pra além do que o Faro guarda.
          </p>
        </section>
